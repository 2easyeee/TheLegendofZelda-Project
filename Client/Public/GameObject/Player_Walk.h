...
NS_BEGIN(Client)
class CPlayer_Walk : public IState
{
private:
...
public:
	...
	{
		return ENUM_TO_UINT(STATE_ID::WALK);
	}
	...
	virtual void OnStateStay(class CActorObject* _pActor, _float _fTimeDelta) override
	{
		...
		{
			CGameInstance::GetInstance()->Play_RandomSound(L"Player_Footstep_Dungeon", 2);
		}
	}
